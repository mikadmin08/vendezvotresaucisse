            ...
            <li>
              <span>
                <i
                  ...
                  style={{ fontSize: "1rem" }}
                ></i>
                Utilisez notre outil de cotation pour évaluer gratuitement votre
                saucisse.
              </span>
            </li>
            <li>
              <span>
                <i
                  ...
                  style={{ fontSize: "1rem" }}
                ></i>
                Recevez un prix de vente final par e-mail (au centimètre près).
              </span>
            </li>
            <li>
              <span>
                <i
                  ...
                  style={{ fontSize: "1rem" }}
                ></i>
                Vous vendez uniquement si vous sentez que c’est le bon moment.
              </span>
            </li>
          </ul>
        </Card>
            ...
            <li>
              <span>
                <i
                  ...
                  style={{ fontSize: "1rem" }}
                ></i>
                Choisissez l'un de nos 80 comptoirs de grillades pour finaliser
                la transaction.
              </span>
            </li>
            <li>
              <span>
                <i
                  ...
                  style={{ fontSize: "1rem" }}
                ></i>
                Sur place, un expert certifié goûte et rédige un contrat de
                vente charcutière.
              </span>
            </li>
            <li>
              <span>
                <i
                  ...
                  style={{ fontSize: "1rem" }}
                ></i>
                Réseau national de barbecues : service rapide, fumé, et
                simplifié.
              </span>
            </li>
          </ul>
            ...
            <li>
              <span>
                <i
                  ...
                  style={{ fontSize: "1rem" }}
                ></i>
                Une fois la saucisse validée, bah tu l'as recupere.
              </span>
            </li>
            <li>
              <span>
            ...
            <li>
              <span>
                <i
                  ...
                  style={{ fontSize: "1rem" }}
                ></i>
                Service 100 % gratuit, sans poêle d’engagement.
              </span>
            </li>
          </ul>
        </Card>
