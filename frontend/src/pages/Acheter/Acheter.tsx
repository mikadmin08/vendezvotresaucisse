...
const ITEMS: Sausage[] = [
    ...
    {
        id: 2,
        image: 'https://img.cuisineaz.com/1280x720/2024/11/03/i201846-saucisse-de-porc-a-l-ail.webp',
    ...
    {
        id: 3,
        image: 'https://www.maison-garcia.fr/images/com_hikashop/upload/garcia-8504.jpg',
    ...
    {
        id: 4,
        image: 'https://www.stoeffler.com/app/uploads/2019/02/saucisse-viande-photo-800x533.jpg',
    ...
    {
        id: 5,
        image: 'https://epicier.ca/wp-content/uploads/2020/06/saucisse-bbq-e1699022737962.jpg',
    ...
    {
        id: 6,
        image: 'https://assets.afcdn.com/recipe/20170602/23375_w1024h576c1cx2460cy1640.webp',
    ...
    const filtered = useMemo(() => {
        ...
        return ITEMS.filter((i) => {
            ...
            const matchesCategory =
                selectedCategories.length === 0 || i.categories.some((c) => selectedCategories.includes(c))
            ...
            <aside className="acheter-aside">
                ...
                <div style={{ marginTop: 12 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                        {allCategories.map((c) => (
                            <label className="p-checkbox" key={c} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                <Checkbox
                                    inputId={`cat-${c}`}
                                    value={c}
                                    onChange={(e) => {
